...
public class PositionControllerForUpdatePositionsIntegrationTest {
	...
	void shouldUpdateTransactionsAndReturnPositions() {
		...
		assertThat(response.getBody()).containsExactlyInAnyOrder(new Position("INF", -70),new Position("REL", 0));
	}
